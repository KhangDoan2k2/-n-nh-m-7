  ...
  public  class NHANVIEN_BUS
    {
        ...
        public bool LoginBUS(string TenDangNhap, string MatKhau) => NHANVIEN_DAO.Instance.DangNhap(TenDangNhap, MatKhau);

        public static List<NHANVIEN> LoadNHANVIEN() => NHANVIEN_DAO.Instance.LoadNHANVIEN();
